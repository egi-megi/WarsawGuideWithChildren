...
//        insertParks();
    ...
    void insertRestaurants() {
        restaurantsList.add(new Attraction(getString(R.string.restaurants_title_nabo), getString(R.string.restaurants_text_nabo), R.drawable.warsaw, getString(R.string.restaurants_phone_nabo), getString(R.string.restaurants_address_nabo), getString(R.string.restaurants_www_nabo), 52.189676, 21.068814));
//        restaurantsList.add(new Attraction(getString(R.string.restaurants_title_akademia), getString(R.string.restaurants_text_akademia), R.drawable.warsaw, getString(R.string.restaurants_phone_akademia), getString(R.string.restaurants_address_akademia), getString(R.string.restaurants_www_akademia), getString(R.string.restaurants_latitude_akademia), getString(R.string.restaurants_longitude_akademia)));
